		...
		hasslium.process(
			...
			(error, output) => {
				...
				expect(output).toEqual(
					fs
						.readFileSync("./test/assets/results/define.js")
						.toString()
						.split("\n")
				);
			}
	...
	test("Conditions", () => {
		hasslium.process(
			...
			(error, output) => {
				...
				expect(output).toEqual(
					fs
						.readFileSync("./test/assets/results/conditions.js")
						.toString()
						.split("\n")
				);
			}
	...
	test("Logging", () => {
		hasslium.process(
			...
			(error, output) => {
				...
				expect(output).toEqual(
					fs
						.readFileSync("./test/assets/results/logging.js")
						.toString()
						.split("\n")
				);
			}
	...
	test("Miscellaneous", () => {
		hasslium.process(
			...
			(error, output) => {
				...
				expect(output).toEqual(
					fs
						.readFileSync("./test/assets/results/misc.js")
						.toString()
						.split("\n")
				);
			}
...
describe("Miscellaneous (no verbose)", () => {
	...
	test("Miscellaneous", () => {
		hasslium.process(
			fs
				.readFileSync("./test/assets/misc_no_verbose.js")
				.toString()
				.split("\n"), // Source
			{ macros: [], verbose: false }, // Options
			(error, output) => {
				...
				expect(output).toEqual(
					fs
						.readFileSync("./test/assets/results/misc_no_verbose.js")
						.toString()
						.split("\n")
				);
			}
